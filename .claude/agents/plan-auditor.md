...
## 호출 조건 (Tier 2-B)
**무조건**: `01_Phases/**/NN-*.md`(Phase 정의) Write/Edit · 마일스톤 계획 신설/갱신.
**스킵**: 오타·주석만.
...
## 점검 축
1. **PRD 정합** — Phase가 PRD 핵심 기능에 매핑? `00_Documents/PRD.md` **MVP 제외 사항**을 침범(scope creep)? FEATURE_MAP의 해당 마일스톤과 일치?

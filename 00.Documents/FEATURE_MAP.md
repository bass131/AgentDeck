...
> AgentCodeGUI 패리티(A~E)와 축이 다른 **Claude Code CLI 벤치마크** — 배포 게이트 = "AgentDeck 안에서 AgentDeck 개발 가능". Phase 정의 = `01.Phases/17_GAP1-core-parity/`, 근거 = `reports/GAP1-Claude-Code-기능격차-감사.html`. (상태 3차 갱신 2026-07-14 — **구현 12/15 완료(P13~P15 확장분 진행, 영호 확장 2026-07-14)**)
...
| P15 | Playwright 라이브 버그 헌팅 루프(라운드제 배포 게이트) | 🚧 |

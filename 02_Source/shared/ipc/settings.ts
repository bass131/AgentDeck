 ...
 *
 * 구현 위치: main-process `02_Source/main/05_settings/skills.ts` (IPC 핸들러 + 스킬 저장).
 ...
 *
 * 구현 위치: main-process `02_Source/main/05_settings/skills.ts`.
 ...
 *
 * 구현 위치: main-process `02_Source/main/05_settings/mcp.ts` (IPC 핸들러 + MCP 서버 발견 + 마스킹).
 ...
 *
 * 구현 위치: main-process `02_Source/main/05_settings/mcp.ts`.
 ...
 *
 * 구현 위치: main-process `02_Source/main/05_settings/commands.ts`

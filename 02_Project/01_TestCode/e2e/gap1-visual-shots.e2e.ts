...
const RENDERER_SRC = join(ROOT, '02_Project/00_Source', 'renderer', 'src')
...
const READ_CARD = {
  id: 'tc-read',
  name: 'Read',
  input: { file_path: '02_Project/00_Source/renderer/src/lib/toolKind.ts' },
  status: 'done',
  result: READ_RESULT,
}
...
const SR_CONTENT = {
  ...
  matches: [
    ...
    { path: '02_Project/00_Source/main/index.ts', line: 42, text: 'app.whenReady().then(bootstrap)' },
    { path: '02_Project/00_Source/renderer/src/App.tsx', line: 7, text: 'export function App(): React.JSX.Element {' },
  ],
...
const SR_FILES = {
  ...
  files: ['02_Project/00_Source/main/01_agents/claudeStream.ts', '02_Project/00_Source/shared/agentEvents.ts', '02_Project/01_TestCode/agents/claudeStream.golden.test.ts'],
  total: 3,
}
...
const SR_COUNT = {
  ...
  toolUseId: 'tc-grep',
  mode: 'count',
  files: ['02_Project/00_Source/main/01_agents/claudeAgentRun.ts', '02_Project/00_Source/main/01_agents/agentRuns.ts'],
  total: 17,
}
...
const SR_GLOB = {
  ...
  toolUseId: 'tc-glob',
  mode: 'glob',
  files: ['02_Project/00_Source/main/index.ts', '02_Project/00_Source/preload/index.ts', '02_Project/00_Source/renderer/src/main.tsx'],
  total: 245,
  truncated: true,
}

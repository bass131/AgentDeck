...
describe('parseSlashQuery', () => {
  it('/ 만 → ""(빈 쿼리) 반환', async () => {
    const { parseSlashQuery } = await import('../../../02_Project/00_Source/renderer/src/hooks/useInputPalettes')
...
describe('parseMentionToken', () => {
  it('@만 입력 → { term: "", start: 0 } 반환', async () => {
    const { parseMentionToken } = await import('../../../02_Project/00_Source/renderer/src/hooks/useInputPalettes')
...
describe('useInputPalettes — slash.open', () => {
  it('value="/" → slash.open=true', async () => {
    const { useInputPalettes } = await import('../../../02_Project/00_Source/renderer/src/hooks/useInputPalettes')

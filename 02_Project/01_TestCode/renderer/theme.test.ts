...
import { applyTheme, getTheme, setTheme } from '../../../02_Project/00_Source/renderer/src/lib/theme'

const css = readFileSync(
  join(process.cwd(), '02_Project/00_Source', 'renderer', 'src', 'theme', 'tokens.css'),
  'utf-8'
)

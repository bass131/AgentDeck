...
const SINGLE = [
  mk('sa-solo', 'explorer', {
    ...
    tools: [
      { id: 'tl-1', verb: 'read', target: '02_Project/00_Source/renderer/src/lib/splitView.ts', status: 'done' },
    ...
    transcript: [
      ...
      { kind: 'tool', id: 'tl-1', verb: 'read', target: '02_Project/00_Source/renderer/src/lib/splitView.ts', status: 'done' },

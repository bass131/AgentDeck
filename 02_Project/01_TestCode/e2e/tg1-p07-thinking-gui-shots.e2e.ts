...
var GIT_STATUS_FIXTURE = {
  ...
  behind: 0,
  changes: [
    { path: '02_Project/00_Source/renderer/src/lib/providerBrand.ts', status: 'A', add: 66, del: 0 },
    { path: '02_Project/00_Source/renderer/src/components/common/ProviderBrandIcon.tsx', status: 'A', add: 34, del: 0 },
    { path: '02_Project/00_Source/renderer/src/features/conversation/Conversation.tsx', status: 'M', add: 12, del: 5 },
  ],
  branches: [

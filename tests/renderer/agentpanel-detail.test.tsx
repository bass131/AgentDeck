...
import type { Todo, SubAgentInfo } from '../../src/renderer/src/lib/agentSampleData'
...
describe('agentSampleData — 구조 검증', () => {
  it('SAMPLE_TODOS: id/label/status 필드 + 3가지 status 존재', async () => {
    const { SAMPLE_TODOS } = await import('../../src/renderer/src/lib/agentSampleData')
  ...
  it('SAMPLE_SUBAGENTS: id/name/role/status/tools 필드', async () => {
    const { SAMPLE_SUBAGENTS } = await import('../../src/renderer/src/lib/agentSampleData')

...
import type { McpServerInfo } from '../../../02_Project/00_Source/shared/ipcContract'
...
async function openMcpTab(): Promise<void> {
  vi.resetModules()
  const { SettingsModal } = await import('../../../02_Project/00_Source/renderer/src/features/shell/SettingsModal')
  await act(async () => {

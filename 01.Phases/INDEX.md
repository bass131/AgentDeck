...
| 15 | — (신설) | `15_HR1-harness-renewal` | 2026-07-12 ~ | 📝 계획 수립 | 하네스 전면 리뉴얼 — 3층 구조(중립 코어/Claude 어댑터/Codex 경량 보조)·훅 관측성(systemMessage+guard-blocks.log)·ADR 세분화·H3 안건 흡수. 6 Phase (Sol 적대 리뷰 No-ship 전건 반영 v2 — Codex 원자 전환 합병). |

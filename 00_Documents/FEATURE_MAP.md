...
| C5 | LSP(호버·정의이동) | ✅ | M2-LSP(Phase 27) | typescript-language-server+pyright 번들. 02.Source/main/03_lsp(StdioRpc·manager rootId 게이트+resolveSafe·생명주기). CodeViewer hoverTooltip(300ms)·F12 정의이동(keymap). 실 TS LSP 라이브 PASS. 다운로드형 C#/C++=후속 |

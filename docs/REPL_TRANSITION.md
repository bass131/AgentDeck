...
| (5b) 렌더러 시각 | ⏳ 잔여(**UI 사인오프**) | — | 컴포저 REPL 토글(default ON, 끄면 단발 -p) + cron-turn 배지(2a) + 정지=interrupt/세션종료 분리(3a) + LoopIndicator를 session_crons 반영. UltraCode 버튼·LoopIndicator 패턴 재활용 |

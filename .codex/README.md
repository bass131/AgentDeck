...
`harness-doctor --live`는 세 permission profile의 Windows 초기화, 네 Hook launcher, Sol·Terra·Luna model catalog를 실제 자식 프로세스로 검사합니다. 정적 TOML이 맞아도 sandbox setup이 실패하는 경우를 이 단계에서 잡습니다.

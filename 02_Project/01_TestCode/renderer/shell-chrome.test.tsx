...
describe('TitleBar — 윈도우 컨트롤', () => {
  it('워크스페이스명을 표시하고 컨트롤 3버튼을 렌더한다', async () => {
    const { TitleBar } = await import('../../../02_Project/00_Source/renderer/src/features/shell/TitleBar')
    await act(async () => {
...
describe('ResizeHandles — 수동 리사이즈 트리거', () => {
  it('8개 엣지/모서리 핸들을 렌더한다', async () => {
    const { ResizeHandles } = await import('../../../02_Project/00_Source/renderer/src/features/shell/ResizeHandles')

...
> AgentCodeGUI 패리티(A~E)와 축이 다른 **Claude Code CLI 벤치마크** — 배포 게이트 = "AgentDeck 안에서 AgentDeck 개발 가능". Phase 정의 = `01.Phases/17_GAP1-core-parity/`, 근거 = `reports/GAP1-Claude-Code-기능격차-감사.html`. (상태 1차 기록 2026-07-14 — 마일스톤 마감 시 2차 갱신)

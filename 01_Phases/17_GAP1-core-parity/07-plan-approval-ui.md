...
> **상태**: done — permissionSummary plan 분기 + planReview{plan,planFilePath} 조건부 부착 + PermissionCard 마크다운 본문·실행 승인/계속 계획 2버튼·fallback(신규 모달 0). 게이트 green(4889pass)·reviewer 위반0(🟡3 advisory). ui-visual 육안 = 영호 트랙
> **마일스톤**: GAP1

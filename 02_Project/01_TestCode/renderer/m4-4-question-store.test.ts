...
import type { AgentQuestion } from '../../../02_Project/00_Source/shared/agentEvents'
...
describe('Phase 24d — appStore: respondQuestion 액션 + selectPendingQuestion 셀렉터', () => {
  ...
  it('selectPendingQuestion: 초기값 null', async () => {
    const { useAppStore, selectPendingQuestion } = await import('../../../02_Project/00_Source/renderer/src/store/appStore')

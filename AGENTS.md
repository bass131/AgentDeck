...
> 현재 [`00_Documents/00_Harness/CORE.md`](00_Documents/00_Harness/CORE.md), NC 개명 후
> `00_Documents/00_Harness/CORE.md`입니다. 어댑터 판정은 번호를 고정하지 않는
> `00_Documents/(?:\d{2}_)?Harness/CORE.md` 규칙을 따릅니다(CORE-01~13, ADR-034 3층 구조).
